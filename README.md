...
### Ingest
- Pulls NFL schedules and weekly player statistics using `nflreadpy`
- Supports single-week and multi-week ingestion

### Model
- Writes normalized, analytics-safe tables into DuckDB
- Separates **core fact tables** from **derived mart tables**
- Uses rolling windows for multi-week metrics

### Analyze & Report
- Computes:
  - Total offensive yards (official NFL definition)
  - Pass share vs run share
  - Offensive dependency on a single player
  - Rolling 3-week consistency / volatility
- Produces Markdown weekly reports
- Ships with a tested SQL analysis pack
...
- **SQL** — analysis and reporting logic
- **VS Code** — development workflow

No cloud services required for v1.
